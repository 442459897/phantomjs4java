...
public class PhantomJSReference {
	...
	public static final String PHANTOMJS_NATIVE_CMD = "D:\\mysoft\\phantomjs\\bin\\phantomjs.exe";
	...
	public static class PhantomJSReferenceBuilder {
		private Version version = Version.v_2_0_0;
	...
	public synchronized void ensureBinary() {
		...
		//if (Version.NATIVE.toString().equals(version)) {
		if (true) {
